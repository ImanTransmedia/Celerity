    ...
    public class AutoExposureRenderFeature : ScriptableRendererFeature
    {
        ...
        class AutoExposureFragmentRenderPass : ScriptableRenderPass
        {
            ...
            public AutoExposureFragmentRenderPass()
            {
                ...
                {
                    downscaledSource[i] = RTHandles.Alloc(Shader.PropertyToID(downscaleId + i), name: downscaleId + i);
                }
            }
            ...
            public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
            {
                ...
                RenderingUtils.ReAllocateIfNeeded(ref target, targetDescriptor, FilterMode.Point, TextureWrapMode.Clamp, name: outputId);
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                */
                ...
                RTHandle persistentData = RTHandles.Alloc(kvp[renderingData.cameraData.camera]);
        ...
        class AutoExposureComputeRenderPass : ScriptableRenderPass
        {
            ...
            public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
            {
                ...
                void SetupRenderTexture(RenderTextureDescriptor descriptor)
                {
                    ...
                    RenderingUtils.ReAllocateIfNeeded(ref aeHandle, descriptor, FilterMode.Point, TextureWrapMode.Clamp, name: handleId);
                }
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                void ExecuteComputeShader(CommandBuffer cmd)
                {
                    ...
                    cmd.SetComputeTextureParam(shader, mainKernel, ShaderParams._AutoExposureTarget, aeHandle.nameID);
                    ...
                    cmd.SetComputeTextureParam(shader, rtKernel, ShaderParams._AutoExposureTarget, aeHandle.nameID);
